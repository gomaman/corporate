...
const Card = ({
  ...
  return (
    <div className={`w-full shadow-xl flex flex-col p-4 ${height} rounded-lg hover:scale-105 duration-300`}>
      ...
      <button
        className={`${buttonBG} md:w-full w-[200px] rounded-md font-bold my-6 mx-auto py-3 ${buttonTC}`}
      >
        Get Started
      </button>
    </div>
